...
// 4. undefined 자료형
let c;
console.log(typeof abc, typeof c); // 선언하지 않은 변수, 값을 초기화 하지 않은 변수는 undefiend
...
//자동 자료 변환
console.log("abc" + 100 + true); // 표현범위가 작은것이 큰것으로 자동적으로 변환됨;;
console.log(100 + true); // 문자 > 숫자 > bool 등 등 ..
